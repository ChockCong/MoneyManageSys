...
class JydwController extends Controller{
    ...
    public function show(Request $request){
        ...
        if($user->Dep!="经营单位") {
            ...
            return view('jydw.index');

    }
    public  function main(Request $request){
        $user=$request->session()->get('user');
        if($user->Dep=="经营单位")
            return view('jydw.main');
        else
            return redirect()->action('LoginController@login');

    }
    public function logo(Request $request){
            return view('jydw.logo');
...
//查询所有数据返回页面显示
    public function searchall(Request $request){
        ...
        return view('jydw.search',compact('row'));
    }
    //条件查询数据返回页面显示
...
//        $row=Jydw::consearch($searchmessage);
//        return view('jydw.search',compact('row'));
...
//        dd($row);
        return view('jydw.detail',compact('row','f'));
    }
    public function rejected(Request $request){
        ...
        $row=Jydw::rejected();
        return view('jydw.rejected',compact('row'));
    }
...
//        dd($row);
        $f=Jydw::getfiles($order);
        return view('jydw.rejecteddetail',compact('row','f'));
    }
...
//            Jydw::altermessage($altermessage)
